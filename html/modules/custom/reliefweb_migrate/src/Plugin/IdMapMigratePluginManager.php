...
namespace Drupal\reliefweb_migrate\Plugin;
 ...
 * @ingroup migration
 */
class IdMapMigratePluginManager extends MigratePluginManager {
  ...
  public function __construct($type, \Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler, $annotation = 'Drupal\Component\Annotation\PluginID') {
    parent::__construct("Plugin/reliefweb_migrate/$type", $namespaces, $module_handler, NULL, $annotation);
