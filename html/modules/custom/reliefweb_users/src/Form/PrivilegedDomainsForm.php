...
class PrivilegedDomainsForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $default_domain_posting_rights = $this->state->get('reliefweb_users_privileged_domains_default_posting_rights', 'allowed');
    ...
    $form['default_domain_posting_rights'] = [
      ...
      '#description' => $this->t('When posting a report, job, or training, privileged domains will use the selected default posting rights when no specific posting rights record exists, instead of "unverified".'),
      '#options' => [
      ...
      '#default_value' => $default_domain_posting_rights,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $this->state->set('reliefweb_users_privileged_domains_default_posting_rights', $form_state->getValue('default_domain_posting_rights'));
