...
/**
 * Provides dynamic permissions for Guideline of different types.
 *
 * @ingroup guidelines
 */
class GuidelinePermissions {
   ...
   *
   * @return array
   *   The Guideline by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Guideline::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\guidelines\Entity\Guideline $type
   *   The Guideline type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Guideline $type) {
    $type_id = $type->id();
