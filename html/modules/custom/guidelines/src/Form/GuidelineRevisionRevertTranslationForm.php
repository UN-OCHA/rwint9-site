...
/**
 * Provides a form for reverting a Guideline revision for a single trans.
 *
 * @ingroup guidelines
 */
class GuidelineRevisionRevertTranslationForm extends GuidelineRevisionRevertForm {
  ...
  public function getFormId() {
    return 'guideline_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $guideline_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $guideline_revision);
